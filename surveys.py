class Question:
    ...
    def __init__(self, question, choices=None, allow_text=False):
        ...
        #If no choices are provided (choices is None), it defaults to a list containing "Yes" and "No".
        if not choices:
            choices = ["Yes", "No"]

        self.question = question
        self.choices = choices
        #allow_text default is False
...
satisfaction_survey = Survey(
    ...
    [
        ...
        Question("Do you like to shop in the morining or night?",
                ['morning','night'])
    ])
...
personality_quiz = Survey(
    ...
    [
        ...
        Question("Do you ever see curly braces when you close your eyes?"),
